function addition() { //Defining and naming the addition function
    var addition = 2+4;
    document.getElementById("Math").innerHTML = "2 + 4 = " + addition; //Print the result in HTML
}
function substraction() { //Defining and naming the substraction function
    var substraction = 5-3;
    document.getElementById("Sub").innerHTML = "5 - 3 = " + substraction; //Print the result in HTML
}
function multiplication() { //Defining and naming the multiplication function
    var multiplication = 5*4;
    document.getElementById("Mult").innerHTML = "5 * 4 = "+ multiplication; //Print the result in HTML
}
